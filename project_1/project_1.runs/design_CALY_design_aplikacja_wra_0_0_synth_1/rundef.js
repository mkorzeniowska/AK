...
ISEStep( "vivado",
         "-log design_CALY_design_aplikacja_wra_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_CALY_design_aplikacja_wra_0_0.tcl" );
