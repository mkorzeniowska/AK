...
HD_PWD='C:/Users/Admin/repozytorium/project_1/project_1.runs/design_CALY_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_CALY_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_CALY_clk_wiz_0_0.tcl
