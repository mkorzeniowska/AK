...
#
# Generated by export_simulation on Tue Jun 02 16:48:20 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './design_lcd.sh' script.

./design_lcd.sh -reset_run
...
./design_lcd.sh -noclean_files

For more information on the script, please type './design_lcd.sh -help'.
